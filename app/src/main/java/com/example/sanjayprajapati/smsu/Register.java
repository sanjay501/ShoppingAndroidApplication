...
import com.example.sanjayprajapati.smsu.R;
...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnregister=(Button)findViewById(R.id.bt_caccount);
    ...
    private class RegisterAsync extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                URL url = new URL("http://dmis.club/dmis_app/register.php");
        ...
        try {
            ...
            if (jsonObject != null) {
                ...
                if (response.equals("true")){
                    Intent homeactivity = new Intent(this, BottomTabbedActivity.class);
